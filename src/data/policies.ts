...
This warranty does not cover damage resulting from mishandling, improper storage, or normal wear and tear. We recommend storing your fragrances away from direct sunlight and extreme temperatures to preserve their integrity.`,
  },
  {
    id: 'shipping',
    title: 'Shipping Policy',
    content: `We offer nationwide delivery across Vietnam through our trusted courier partners. Standard delivery typically takes 2–4 business days within Hanoi and Ho Chi Minh City, and 4–7 business days for other provinces. Express same-day delivery is available for orders placed before 12:00 noon within the Hanoi metropolitan area.

Orders are processed Monday through Saturday. Orders placed on Sundays or public holidays will be processed on the next business day. Once your order has been dispatched, you will receive a confirmation email with a tracking number.

Shipping fees are calculated at checkout based on your delivery location and the weight of your order. Orders above 500,000 VND qualify for free standard shipping within Hanoi and Ho Chi Minh City.`,
  },
  {
    id: 'sales',
    title: 'Sales Policy',
...
In the event of a pricing error, we will notify you as soon as possible and give you the option to proceed at the correct price or cancel your order for a full refund.`,
  },
  {
    id: 'payment',
...
We do not store any payment information on our servers. All transactions are conducted securely through established banking channels. If you encounter any payment issues, please contact our support team immediately.`,
  },
  {
    id: 'privacy',
